...
app.get('/dashboard', isLoggedIn, function(req, res) {
		posts.find(function (err, psts) {
			...
			pst_string += '<div class="ui segments"><div class="ui left aligned segment"><a class="ui blue ribbon label">Class Post</a><span></span><!--<h3 class="writing">Rick Melucci</h3>--><p class="post">' + psts[i]['post'] + '</p></div></div>';
